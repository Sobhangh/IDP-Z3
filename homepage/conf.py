...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.todo', 'sphinx.ext.ifconfig',
              'sphinx.ext.viewcode', 'sphinxcontrib.video', 'sphinxcontrib.youtube']
...
project = 'IDP-Z3'
copyright = '2020 - KU Leuven, DTAI, KRR'
...
html_static_path = ["_static", "IDP-Z3", "Interactive-Consultant", "Rust"]
