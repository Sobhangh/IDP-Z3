...
Support for the tool can be found in the online `documentation <https://idp-z3.readthedocs.io/en/stable/>`_, including a guide on how to install the IDP-Z3 system for use offline.
