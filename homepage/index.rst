...
Support for the tool can be found in the online `documentation <https://www.idp-z3.be/en/stable/>`_, including a guide on how to install the IDP-Z3 system for use offline.
