...
def update_exprs(self: Expression, new_exprs: List[Expression]) -> Expression:
...
def update_exprs(self: AIfExpr, new_exprs: List[Expression]) -> Expression:
...
def update_exprs(self: AQuantification, new_exprs: List[Expression]) -> Expression:
    if self.q == '∀':
...
def update_exprs(self: AImplication, new_exprs: List[Expression]) -> Expression:
...
def update_exprs(self: AEquivalence, new_exprs: List[Expression]) -> Expression:
...
def update_exprs(self: AComparison, new_exprs: List[Expression]) -> Expression:
...
def update_exprs(self: ASumMinus, new_exprs: List[Expression]) -> Expression:
...
def update_exprs(self: AMultDiv, new_exprs: List[Expression]) -> Expression:
    operands = list(new_exprs)
...
def update_exprs(self: APower, new_exprs: List[Expression]) -> Expression:
    operands = list(new_exprs)
    if len(operands) == 2 \
...
def update_exprs(self: AUnary, new_exprs: List[Expression]) -> Expression:
...
def update_exprs(self: AAggregate, new_exprs: List[Expression]) -> Expression:
    operands = list(new_exprs)
...
def update_exprs(self: AppliedSymbol, new_exprs: List[Expression]) -> Expression:
...
def update_exprs(self: SymbolExpr, new_exprs: List[Expression]) -> Expression:
...
def update_exprs(self: Brackets, new_exprs: List[Expression]) -> Expression:
