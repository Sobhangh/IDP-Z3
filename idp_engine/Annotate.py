...
def annotate(self: AppliedSymbol,
             voc: Vocabulary,
             q_vars: dict[str, Variable],ltc=False,temporal_head=-1) -> Annotated:
    if self.symbol:
...
def annotate(self, voc, q_vars,ltc=False,temporal_head=-1):
    if ltc and temporal_head != -1: #and temporal_head != 0
